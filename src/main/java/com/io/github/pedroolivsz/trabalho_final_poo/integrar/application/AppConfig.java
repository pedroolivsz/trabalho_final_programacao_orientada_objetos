...
public class AppConfig {
    private LojaView configurarLojaApp() {
        ...
        return new LojaView(lojaController, transacaoController, produtoView, transacaoView, fornecedorView);
    }

    private AgenciaBancariaView configurarAgenciaApp() {
        ...
        return new AgenciaBancariaView(agenciaBancariaController, comprovanteView);
    }

    public ProjetosView configurarProjetos() {
        return new ProjetosView(configurarLojaApp(), configurarAgenciaApp());
    }
}
